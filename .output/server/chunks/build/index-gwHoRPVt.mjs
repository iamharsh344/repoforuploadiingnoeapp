...
const _sfc_main = {
  ...
  setup() {
    useHead({
      title: "Grow a Garden Values | Gears - SilverFoxValues",
      htmlAttrs: {
        lang: "en"
      },
      meta: [
        ...
        { hid: "keywords", name: "keywords", content: "Grow a Garden gears, Grow a Garden values, Grow a Garden Roblox, pet values, item values, crop values, Grow a Garden trading, gag gears, SilverFoxValues" },
  ...
  methods: {
    ...
    // async fetchItems() {
    //     try {
    //         const response = await fetch('https://api.silverfoxvalues.com/growagarden?category=gears');
    //         this.items = await response.json();
    //         this.activeCategory = 'gears'
    //        this.isLoaded = true
    //     } catch (error) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/growagarden/gears/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { index as default };
//# sourceMappingURL=index-gwHoRPVt.mjs.map
