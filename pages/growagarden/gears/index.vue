          ...
          >
            ...
            <div class="space-y-2 mb-4">
              ...
              <div class="flex justify-between items-center">
                ...
                <span class="text-base px-2 py-1 rounded-full font-semibold">{{ item.type }}</span>
              </div>
              <div class="flex justify-between items-center">
              ...
              <!-- <div class="flex justify-between items-center">
                ...
                <span :class="getTrendClass(item.trend)" class="text-sm flex items-center">
                  <i :class="getTrendIcon(item.trend)" class="mr-1"></i>{{ item.trend }}
                </span>
              </div> -->
            </div>
            ...
            <div class="space-y-4">
              <div>
                ...
                <div class="flex justify-between items-center bg-gray-800 rounded-lg p-3">
                  ...
                  <span :class="getTrendClass(selectedItem.trend)" class="flex items-center">
                    <i :class="getTrendIcon(selectedItem.trend)" class="mr-1"></i>{{ selectedItem.trend }}
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="space-y-2">
                    ...
                    <span class="text-white">{{ selectedItem.type }}</span>
                  </div>
                  <div class="flex justify-between items-center">
              ...
              <div class="border-t border-gray-600 pt-4">
                <p class="text-gray-400 text-xs mb-2">{{ selectedItem.lastUpdated }}</p>
              </div>
            </div>
          </div>
        </div>
...
methods: {
    ...
    getTrendIcon(trend) {
        // if (trend.includes('+')) return 'fas fa-arrow-up';
        // if (trend.includes('-')) return 'fas fa-arrow-down';
        return 'fas fa-minus';
    },
    // async fetchItems() {
    //     try {
