<template>
    <div class="text-white game-body">
      <main-Header />
      ...
      <div class="container mx-auto px-6 pb-12 min-h-[450px]">
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <div 
            ...
            :key="item.id"
            :class="`item-card rounded-xl p-6 relative ${'rarity-' + item.rarity.toLowerCase()}`"
          >
            ...
            <div class="space-y-2 mb-4">
                <div class="flex justify-between items-center">
                  <span class="text-gray-300 text-sm">Value:</span>
                  <span class="value-badge text-base px-2 py-1 rounded-full font-semibold flex gap-1">
                ...
                <span class="text-sm px-2 py-1 rounded-full font-semibold">{{ item.rarity }}</span>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-gray-300 text-sm">Demand:</span>
                <span class="text-sm px-2 py-1 rounded-full font-semibold">{{ item.demand }}</span>
              </div>
              
              <div class="flex justify-between items-center">
                <span class="text-gray-300 text-sm">Points:</span>
                <span class="text-sm px-2 py-1 rounded-full font-semibold">{{ item.price }}</span>
              </div>
              <div class="flex justify-between items-center">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="space-y-2">
                    ...
                    <span class="text-white">{{ selectedItem.rarity }}</span>
                  </div>
                  <div class="flex justify-between items-center">
                    <span class="text-gray-300">Limited: </span>
                    <span class="text-white">{{ selectedItem.limited }}</span>
                  </div>
                  <div class="flex justify-between items-center">
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <span class="text-white">{{ selectedItem.price }}</span>
                  </div>
                </div>
              </div>
