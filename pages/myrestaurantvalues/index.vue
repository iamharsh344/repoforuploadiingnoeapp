        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          >
            <div class="absolute top-3 right-3">
              <span class="category-badge text-xs px-2 py-1 rounded-full font-semibold">{{ item.category }}</span>
            </div>
            
            <div class="text-center mb-4">
              <div class="w-24 h-24 mx-auto mb-3 rounded-full flex items-center justify-center">
                <img :alt="item.imageName" :src="`https://storage.silverfoxvalues.com/mr/${item.imageName}`" loading="lazy">
              </div>
            ...
            <div class="space-y-2 mb-4">
              <div class="flex justify-between items-center">
                ...
                <span class="value-badge text-sm px-2 py-1 rounded-full font-bold">{{ Number(item.value).toLocaleString('en-US') }}💎</span>
              </div>
              <div class="flex justify-between items-center">
          ...
          <div v-if="selectedItem">
            <div class="text-center mb-6">
              <div class="mb-4 flex justify-center">
                <img :alt="selectedItem.imageName" :src="`https://storage.silverfoxvalues.com/mr/${selectedItem.imageName}`">
              </div>
              <h2 class="text-2xl font-bold text-white mb-2">{{ selectedItem.name }}</h2>
              <div class="flex justify-center items-center space-x-2 mb-4">
                <span class="bg-purple-600 text-xs px-2 py-1 rounded-full">{{ selectedItem.category }}</span>
              </div>
            </div>
            
            <div class="space-y-4">
              <div>
                <h1 class="font-semibold text-white mb-2">Current Value</h1>
                <div class="flex justify-between items-center bg-gray-800 rounded-lg p-3">
                  <span class="text-green-400 font-bold text-lg">{{ Number(selectedItem.value).toLocaleString('en-US') }}💎</span>
              ...
              <div>
                <h1 class="font-semibold text-white mb-2">Description</h1>
