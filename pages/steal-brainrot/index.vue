  <template>
    <div>
        <MainHeader />
        <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 pt-24">
          <div class="container mx-auto px-6 py-8">
      
            <div class="text-center mb-4">
              <h1
                class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-300 mb-4">
                Steal a Brainrot
              </h1>
              <p class="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
                Complete dictionary of all brainrot characters and mutation multipliers for
                <br>the ultimate Roblox gaming experience
              </p>
            </div>
            ...
            <div class="max-w-2xl mx-auto mb-12">
              <div class="relative">
                <input
                  v-model="searchQuery"
                  type="text"
                  placeholder="Search brainrot characters..."
                  class="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400
                         focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-colors duration-200"
                />
          ...
          <div class="grid sm:grid-cols-3 grid-cols-1 gap-6 mb-8">
              <div class="bg-gray-800 border border-gray-700 rounded-lg p-6">
                <div class="flex items-center mb-2">
                  ...
                  <span class="text-gray-400 text-sm">Total Characters</span>
                </div>
                <div class="text-3xl font-bold text-teal-400">58</div>
              </div>
              ...
              <div class="bg-gray-800 border border-gray-700 rounded-lg p-6">
                <div class="flex items-center mb-2">
                  ...
                  <span class="text-gray-400 text-sm">Rarity Types</span>
                </div>
              ...
              <div class="bg-gray-800 border border-gray-700 rounded-lg p-6">
                <div class="flex items-center mb-2">
                  ...
                  <span class="text-gray-400 text-sm">Mutations</span>
                </div>
                <div class="text-3xl font-bold text-blue-400">9</div>
              </div>
            </div>
            ...
            <div class="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-8">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-white text-xl font-semibold">Mutation Multipliers</h2>
                </div>

                <div class="grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-1 gap-4 mb-6">
                    <div class="bg-gray-700 border border-gray-600 rounded-lg p-4 text-center">
                        <div class="text-teal-400 text-sm font-medium mb-1">Gold</div>
                        <div class="text-white text-2xl font-bold">1.25x</div>
                    </div>
                    <div class="bg-gray-700 border border-gray-600 rounded-lg p-4 text-center">
                        <div class="text-teal-400 text-sm font-medium mb-1">Diamond</div>
                        <div class="text-white text-2xl font-bold">1.5x</div>
                    </div>
                    <div class="bg-gray-700 border border-gray-600 rounded-lg p-4 text-center">
                        <div class="text-teal-400 text-sm font-medium mb-1">Rainbow</div>
                        <div class="text-white text-2xl font-bold">10x</div>
                    </div>
                    <div class="bg-gray-700 border border-gray-600 rounded-lg p-4 text-center">
                        <div class="text-teal-400 text-sm font-medium mb-1">Candy</div>
                        <div class="text-white text-2xl font-bold">4x</div>
                    </div>
                </div>

                <h3 class="text-purple-300 text-lg font-medium mb-4">Event Mutations</h3>
                <div class="grid lg:grid-cols-5 sm:grid-cols-3 grid-cols-1 gap-4">
                    <div class="bg-gradient-to-br from-purple-800 to-purple-900 rounded-lg p-4 text-center border border-purple-700">
                        <div class="text-purple-300 text-sm font-medium mb-1">Bloodrot</div>
                        <div class="text-white text-xl font-bold">2x</div>
                    </div>
                    <div class="bg-gradient-to-br from-purple-800 to-purple-900 rounded-lg p-4 text-center border border-purple-700">
                        <div class="text-purple-300 text-sm font-medium mb-1">Tacos</div>
                        <div class="text-white text-xl font-bold">3x</div>
                    </div>
                    <div class="bg-gradient-to-br from-purple-800 to-purple-900 rounded-lg p-4 text-center border border-purple-700">
                        <div class="text-purple-300 text-sm font-medium mb-1">Disco</div>
                        <div class="text-white text-xl font-bold">4x</div>
                    </div>
                    <div class="bg-gradient-to-br from-purple-800 to-purple-900 rounded-lg p-4 text-center border border-purple-700">
                        <div class="text-purple-300 text-sm font-medium mb-1">Firework</div>
                        <div class="text-white text-xl font-bold">6x</div>
                    </div>
                    <div class="bg-gradient-to-br from-purple-800 to-purple-900 rounded-lg p-4 text-center border border-purple-700">
                        <div class="text-purple-300 text-sm font-medium mb-1">Nyancat</div>
                        <div class="text-white text-xl font-bold">6x</div>
                    </div>
                </div>
            </div>
            ...
            <div
              ...
              :key="category.name"
              class="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-8">
              <div class="mb-6">
                <h2 class="text-white font-medium text-lg">
                  {{ category.name }}
                  <span class="text-gray-400">({{ category.characters.length }} characters)</span>
                </h2>
              </div>
      
              <div class="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
                <div
                  v-for="char in category.characters"
                  :key="char.id"
                  class="bg-gray-700 rounded-lg border border-gray-600 p-4 hover:border-teal-500 transition-colors duration-200 cursor-pointer">
                  <h3 class="text-white font-medium text-base mb-2">{{ char.name }}</h3>
                  <div class="flex items-center">
                    <svg class="w-4 h-4 text-teal-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    </svg>
                    <span class="text-teal-400 font-medium">{{ char.speed }}</span>
                  </div>
                </div>
              </div>
      
              <div
                v-if="category.characters.length === 0 && searchQuery"
                class="text-center py-8 text-gray-400">
                No {{ category.name.toLowerCase() }} characters match “{{ searchQuery }}”
              </div>
            </div>
          </div>
        </div>
